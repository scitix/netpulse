...
class NetPulseClient:
    ...
    def _wait_for_result_with_progressive_retry(self, job_id: str, 
    ...
    def exec_command(self, device: Union[ConnectionArgs, Dict], command: Union[str, List[str]], driver: Optional[str] = None, **kwargs) -> CommandResult:
        """
    ...
    def exec_config(self, device: Union[ConnectionArgs, Dict], config: Union[str, List[str], Dict], driver: Optional[str] = None, **kwargs) -> ConfigResult:
        """
    ...
    def bulk_command(self, devices: List[Union[ConnectionArgs, Dict]], connection_args: Dict, command: Union[str, List[str]], driver: Optional[str] = None, **kwargs) -> BatchResult:
        """
    ...
    def bulk_config(self, devices: List[Union[ConnectionArgs, Dict]], connection_args: Dict, config: Union[str, List[str], Dict], driver: Optional[str] = None, **kwargs) -> BatchResult:
        """
    ...
    def get_jobs(self, job_id: Optional[str] = None, queue: Optional[str] = None,
                status: Optional[str] = None, node: Optional[str] = None,
                host: Optional[str] = None) -> List[JobInfo]:
        """获取任务列表"""
        params = {}
        if job_id:
            params["id"] = job_id
    ...
    def delete_jobs(self, job_id: Optional[str] = None, queue: Optional[str] = None,
    ...
    def get_workers(self, queue: Optional[str] = None, node: Optional[str] = None,
                   host: Optional[str] = None) -> List[WorkerInfo]:
        """获取Worker列表"""
        params = {}
        if queue:
            params["queue"] = queue
    ...
    def delete_workers(self, name: Optional[str] = None, queue: Optional[str] = None,
    ...
    def test_connection(self, device: Union[ConnectionArgs, Dict], driver: Optional[str] = None) -> ConnectionTestResult:
    ...
    def execute(self, device: ConnectionArgs, command: Union[str, List[str]], **kwargs) -> CommandResult:
        """向后兼容的命令执行方法"""
    ...
    def configure(self, device: ConnectionArgs, config: Union[str, List[str]], **kwargs) -> ConfigResult:
        """向后兼容的配置推送方法"""
        result = self.exec_config(
            device=device,
            config=config,
            **kwargs
        )
